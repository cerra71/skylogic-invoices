/**
 * Entity representing the invoice_st table.
 * It contains invoice data in the staging phase, before validation
...
@Entity
@Table(name = "invoice_st", schema = "public")
...
public class InvoiceSt {
    ...
    // Typo into the database, but correct name in Java
    @Column(name = "additonal_imsi", length = 4000)
